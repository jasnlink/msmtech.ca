...
export async function generateMetadata(
    ...
    const alternateLngPages = languages.reduce((acc, lng) => ({ ...acc, [lng]: `${process.env.NEXT_PUBLIC_HOST}/${lng}/terms-of-service`}), {})
    ...
    return {
        ...
        alternates: {
            languages: {
                ...alternateLngPages,
                'x-default': `${process.env.NEXT_PUBLIC_HOST}/${fallbackLng}/terms-of-service`,
            }
        }
    }
}
